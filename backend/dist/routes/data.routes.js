...
function simulateCDFProcessing(filename, fileSizeBytes) {
    return [
        {
...
router.post('/upload', upload.single('cdfFile'), (req, res) => {
    const file = req.file;
    if (!file) {
...
router.get('/longitude-matrix', (_req, res) => {
    res.json({
