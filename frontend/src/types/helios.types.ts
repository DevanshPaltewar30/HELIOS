// ============================================================
// HELIOS Frontend - Shared TypeScript Types
// Mirror of backend types for seamless API communication
// ============================================================
...
export type ActiveTab = 'realtime' | 'drivers' | 'diagnostics' | 'evaluation';
export type CmePhase = 'AMBIENT' | 'SHEATH' | 'EJECTA' | 'RECOVERY';
